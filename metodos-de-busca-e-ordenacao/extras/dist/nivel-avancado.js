...
class HeapSortCompleto {
     ...
     */
    static heapificar(arr, tamanho, indiceRaiz, contexto) {
    ...
    static visualizarHeap(array) {
        ...
        for (let i = 0; i < n; i++) {
            ...
            if (i > 0)
                console.log(`  👆 Pai: índice ${pai} (valor ${array[pai]})`);
...
class BuscaAvancada {
     ...
     */
    static buscaTernaria(array, elemento) {
     ...
     */
    static buscaInterpolada(array, elemento) {
     ...
     */
    static compararAlgoritmosBusca(array, elemento) {
...
class AlgoritmosHibridos {
     ...
     */
    static timSortSimplificado(array) {
        const arr = [...array];
        const minMerge = 32;
     ...
     */
    static insertionSortOtimizado(array) {
     ...
     */
    static insertionSortOtimizadoRange(array, inicio, fim) {
     ...
     */
    static merge(array, inicio, meio, fim) {
    ...
    static introSortRecursivo(array, inicio, fim, profundidadeMax) {
        if (inicio < fim) {
    ...
    static particionarIntro(array, inicio, fim) {
    ...
    static heapSortRange(array, inicio, fim) {
