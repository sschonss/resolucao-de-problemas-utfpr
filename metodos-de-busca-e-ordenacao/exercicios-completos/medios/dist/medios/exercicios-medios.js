...
exports.AlgoritmosHibridos = exports.BuscaComDuplicatas = exports.OrdenadorObjetos = exports.AnalisadorEstabilidade = exports.BuscaArrayRotacionado = exports.OrdenadorMatrizes = exports.BuscaExponencial = exports.BuscaTernaria = exports.CombSort = exports.BucketSort = exports.RadixSort = exports.ArvoreBinariaBusca = exports.CountingSort = exports.BuscaInterpolacao = exports.HeapSort = exports.ShellSort = exports.QuickSort = exports.MergeSort = void 0;
...
function verificarOrdenado(array) {
 ...
 */
class BucketSort extends classes_base_1.AlgoritmoOrdenacaoBase {
    ordenar(array) {
        this.resetarEstatisticas();
        const resultado = [...array];
        if (resultado.length === 0)
...
function exercicio9() {
    ...
    console.log("Array original:", dados);
    const { resultado, tempo } = classes_base_1.MedidorPerformance.medirTempo(() => bucketSort.ordenar(dados));
    console.log("Array ordenado:", resultado);
    console.log("Tempo de execução:", tempo.toFixed(4), "ms");
 ...
 */
class CombSort extends classes_base_1.AlgoritmoOrdenacaoBase {
    ordenar(array) {
        this.resetarEstatisticas();
        const resultado = [...array];
        const n = resultado.length;
    ...
    getNome() { return "Comb Sort"; }
    getComplexidade() { return "O(n²) pior caso, O(n log n) médio"; }
    isEstavel() { return false; }
}
...
function exercicio10() {
    ...
    console.log("Array original:", dados);
    const { resultado, tempo } = classes_base_1.MedidorPerformance.medirTempo(() => combSort.ordenar(dados));
    console.log("Array ordenado:", resultado);
    console.log("Tempo de execução:", tempo.toFixed(4), "ms");
 ...
 */
class BuscaTernaria extends classes_base_1.AlgoritmoBuscaBase {
    buscar(array, elemento) {
        this.resetarEstatisticas();
        return this.buscaTernariaRecursiva(array, elemento, 0, array.length - 1);
    }
    buscaTernariaRecursiva(array, elemento, esquerda, direita) {
        if (esquerda > direita) {
            return -1;
        }
    ...
    getNome() { return "Busca Ternária"; }
    getComplexidade() { return "O(log₃ n)"; }
    requerOrdenado() { return true; }
}
exports.BuscaTernaria = BuscaTernaria;
function exercicio11() {
    ...
    console.log("Array ordenado:", dados);
    console.log("Buscando elemento:", elemento);
    const { resultado, tempo } = classes_base_1.MedidorPerformance.medirTempo(() => buscaTernaria.buscar(dados, elemento));
    console.log("Índice encontrado:", resultado);
    console.log("Tempo de execução:", tempo.toFixed(4), "ms");
 ...
 */
class BuscaExponencial extends classes_base_1.AlgoritmoBuscaBase {
    buscar(array, elemento) {
        this.resetarEstatisticas();
        if (array.length === 0)
            return -1;
    ...
    buscaBinaria(array, elemento, esquerda, direita) {
    ...
    getNome() { return "Busca Exponencial"; }
    getComplexidade() { return "O(log n)"; }
    requerOrdenado() { return true; }
}
exports.BuscaExponencial = BuscaExponencial;
function exercicio12() {
    ...
    console.log("Array ordenado:", dados);
    console.log("Buscando elemento:", elemento);
    const { resultado, tempo } = classes_base_1.MedidorPerformance.medirTempo(() => buscaExponencial.buscar(dados, elemento));
    console.log("Índice encontrado:", resultado);
    console.log("Tempo de execução:", tempo.toFixed(4), "ms");
...
class OrdenadorMatrizes {
    ...
    static ordenarElementos(matriz) {
    ...
    static ordenarLinhasPorSoma(matriz) {
...
exports.OrdenadorMatrizes = OrdenadorMatrizes;
 ...
 */
class BuscaArrayRotacionado extends classes_base_1.AlgoritmoBuscaBase {
    buscar(array, elemento) {
        this.resetarEstatisticas();
        return this.buscaRotacionada(array, elemento, 0, array.length - 1);
    }
    buscaRotacionada(array, elemento, esquerda, direita) {
        if (esquerda > direita)
            return -1;
        const meio = Math.floor((esquerda + direita) / 2);
    ...
    getNome() { return "Busca em Array Rotacionado"; }
    getComplexidade() { return "O(log n)"; }
    requerOrdenado() { return false; } // Array está ordenado mas rotacionado
}
exports.BuscaArrayRotacionado = BuscaArrayRotacionado;
function exercicio14() {
    ...
    elementos.forEach(elemento => {
        const { resultado, tempo } = classes_base_1.MedidorPerformance.medirTempo(() => buscaRotacionada.buscar(dados, elemento));
        ...
        for (let i = 0; i < ordenado.length - 1; i++) {
            for (let j = i + 1; j < ordenado.length; j++) {
                if (ordenado[i].chave === ordenado[j].chave) {
                    ...
                    const posI = original.findIndex(item => item.chave === ordenado[i].chave && item.valor === ordenado[i].valor);
                    const posJ = original.findIndex(item => item.chave === ordenado[j].chave && item.valor === ordenado[j].valor);
                    if (posI > posJ) {
...
exports.AnalisadorEstabilidade = AnalisadorEstabilidade;
...
class OrdenadorObjetos {
    static ordenarPessoas(pessoas, prioridades) {
    ...
    static ordenarPessoasEstavel(pessoas, prioridades) {
...
exports.OrdenadorObjetos = OrdenadorObjetos;
 ...
 */
class BuscaComDuplicatas extends classes_base_1.AlgoritmoBuscaBase {
    buscar(array, elemento) {
        this.resetarEstatisticas();
        return this.buscaOtimizadaDuplicatas(array, elemento);
    }
    buscaOtimizadaDuplicatas(array, elemento) {
    ...
    encontrarIntervalo(array, elemento) {
        this.resetarEstatisticas();
        let primeiro = -1;
        let ultimo = -1;
        for (let i = 0; i < array.length; i++) {
    ...
    getNome() { return "Busca Otimizada para Duplicatas"; }
    getComplexidade() { return "O(n) pior caso, O(k) para arrays ordenados com k duplicatas"; }
    requerOrdenado() { return false; }
}
exports.BuscaComDuplicatas = BuscaComDuplicatas;
...
class AlgoritmosHibridos {
    ...
    static introSortRecursivo(array, esquerda, direita, profundidade) {
    ...
    // Métodos auxiliares
    static insertionSort(array, esquerda, direita) {
    ...
    static heapSort(array, esquerda, direita) {
    ...
    static heapify(array, n, i, offset) {
        let maior = i;
        const esquerda = 2 * i + 1;
        const direita = 2 * i + 2;
    ...
    static particionar(array, esquerda, direita) {
    ...
    static mesclar(array, esquerda, meio, direita) {
        const n1 = meio - esquerda + 1;
        const n2 = direita - meio;
        const esquerdaArray = array.slice(esquerda, meio + 1);
        const direitaArray = array.slice(meio + 1, direita + 1);
...
exports.AlgoritmosHibridos = AlgoritmosHibridos;
function exercicio18() {
    console.log("\n=== EXERCÍCIO 18: ALGORITMOS HÍBRIDOS ===\n");
    const dados = classes_base_1.ArrayUtils.gerarAleatorio(100, 1, 1000);
    console.log("Array original (primeiros 20 elementos):", dados.slice(0, 20));
    console.log("\nIntro Sort (Quick + Heap + Insertion):");
    const { resultado: introResultado, tempo: introTempo } = classes_base_1.MedidorPerformance.medirTempo(() => AlgoritmosHibridos.introSort(dados));
    ...
    const { resultado: timResultado, tempo: timTempo } = classes_base_1.MedidorPerformance.medirTempo(() => AlgoritmosHibridos.timSort(dados));
    ...
    const quickSort = new QuickSort();
    const mergeSort = new MergeSort();
    const quickTempo = classes_base_1.MedidorPerformance.medirTempo(() => quickSort.ordenar(dados)).tempo;
    const mergeTempo = classes_base_1.MedidorPerformance.medirTempo(() => mergeSort.ordenar(dados)).tempo;
